...
const LogInPageAdmin = () => {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      // NOTE: with the current backend, new users will default to role 'freelancer'.
      // To make them a *real* admin, you can later update their role in MySQL.
      const data = await signup({
        fullname: signupFullname,
        username: signupIdentifier,
        email: null,
      ...
      // Go to AdminPage after successful sign up
      navigate("/admin");
    } catch (err) {
